...
namespace Database.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Created = table.Column<DateTime>(nullable: false),
                    ScannerAddressId = table.Column<int>(nullable: false),
                    TrackerAddressId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Registrations_Addresses_ScannerAddressId",
                        column: x => x.ScannerAddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Registrations_Addresses_TrackerAddressId",
                        column: x => x.TrackerAddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registrations_ScannerAddressId",
                table: "Registrations",
                column: "ScannerAddressId");

            migrationBuilder.CreateIndex(
                name: "IX_Registrations_TrackerAddressId",
                table: "Registrations",
                column: "TrackerAddressId");
