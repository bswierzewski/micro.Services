...
namespace Database.Migrations
{
    ...
    [Migration("20200918085044_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entities.Registration", b =>
                {
                    ...
                    b.Property<int>("ScannerAddressId")
                        .HasColumnType("integer");

                    b.Property<int>("TrackerAddressId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("ScannerAddressId");

                    b.HasIndex("TrackerAddressId");
            ...
            modelBuilder.Entity("Database.Entities.Registration", b =>
                {
                    b.HasOne("Database.Entities.Address", "ScannerAddress")
                        .WithMany()
                        .HasForeignKey("ScannerAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Database.Entities.Address", "TrackerAddress")
                        .WithMany()
                        .HasForeignKey("TrackerAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
